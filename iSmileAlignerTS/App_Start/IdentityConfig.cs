...
namespace iSmileAlignerTS
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var mail = new System.Net.Mail.MailMessage("info@thinortho.com", message.Destination);
            mail.SubjectEncoding = System.Text.Encoding.UTF8;
            string body = "<!doctype html><html><head><meta charset=\"utf-8\"></head><body><p><pre>" + message.Body + "</p></pre><p>" + "Ihr iSmileAligner Team (gesendet von " + Environment.MachineName + ")</p></body></html>";
